...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/download`, changeFrequency: "weekly", priority: .9 },
    ...
    ...features.map((feature) => ({ url: `${base}/features/${feature.slug}`, changeFrequency: "monthly" as const, priority: feature.slug === "meal-planner" ? .9 : .7 })),
